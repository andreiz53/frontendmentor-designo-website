...
<style scoped>
.locations-row {
  @apply grid grid-cols-[350px_350px_350px] justify-between max-w-m mx-auto;
}
h3 {
  @apply uppercase;
}
...
.canada .img-container::before,
.australia .img-container::before,
.uk .img-container::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
